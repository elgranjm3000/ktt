    ...
    <div class="shell">
		...
		<nav id="navigation">
			...
			<ul>
                ...
                <li><a href="preguntas-frecuentes.php?page=1" target="_parent" class="active">Preguntas Frecuentes</a></li>
            ...
            <div class="slider-wrapper theme-default">
                ...
                <ol><div id="slider" class="nivoSlider">
                    ...
                    <?php
                        ...
                        $sql = "select imagen_1, imagen_2, imagen_3, imagen_4, imagen_5, imagen_6, metas_1, metas_2, metas_3, metas_4, metas_5, metas_6 from ktz_imagenes_slider where estado = 1 and tipo = 5";
...
<div class="shell">
	...
	<section id="contepf">
    	...
    	<div class="titulo"><h1>PREGUNTAS FRECUENTES</h1></div>
        ...
        <div class="fil1" >
			...
			<ol start="" id="paginator_galeria">
                ...
                <?php
                    ...
                    $sql = "select pregunta, respuesta from ktz_preguntas_frecuentes where estado = 1";
...

                    {
                        ...
                        if($obj_secciones->valor('pregunta') != "")

                        {

                            echo '<li>';

                                echo '<strong>'.$obj_secciones->valor('pregunta').'</strong>';

                                echo '<p>'.$obj_secciones->valor('respuesta').'</p>';
