    ...
    $(function(){
...

        {
...

            {
                ...
                $.ajax({
...

                    {
                        ...
                        $("#msj_enviar").html("Sending query... <img src='resources/img/loading.gif' width=16 height=16 />");
                    ...
                    success:function(data){
                        ...
                        if(data != 1)
                            ...
                            $("#msj_enviar").html("There was problem sending the query");
...

                        {
                            ...
                            alert("Thank you. Your inquiry was sent successfully. Soon we will contact you.")
...

            {
                ...
                alert("Please enter Name and Email to make the query");
            	...
            	<div class="col31">
                    ...
                    <nav class="idioma-nav">
                        ...
                        <ul>
                          ...
                          <li><a href="#"><img src="../resources/img/icono-ktz-login-0.png"></a></li>
