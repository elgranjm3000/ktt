...
<script type="text/javascript">
	...
	$(function(){
        ...
        $("#gallerySlider .placeholder").html("s");
        ...
        $(".holder a.jp-next").html("&#187;");



        $(".holder a.jp-last").html("Last &#187;");
...

{
    ...
    color: #b163a3;font-weight: normal;
    ...
    <div class="shell">
		...
		<nav id="navigation">
			...
			<ul>
                ...
                <li><a href="galeria.php" target="_parent" class="active">Gallery</a></li>
            ...
            <div class="slider-wrapper theme-default">
                ...
                <ol><div id="slider" class="nivoSlider">
                    ...
                    <?php
                        ...
                        $sql = "select imagen_1_en, imagen_2_en, imagen_3_en, imagen_4_en, imagen_5_en, imagen_6_en, metas_1_en, metas_2_en, metas_3_en, metas_4_en, metas_5_en, metas_6_en from ktz_imagenes_slider where estado = 1 and tipo = 4";
...
<div class="shell">
	...
	<section id="contegaleria">
        ...
        <div class="fil1">
            ...
            <div class="titulo"><h1>GALLERY</h1></div>
        ...
        <?php
            ...
            $sql = "select imagen, metas from ktz_galeria_fotos where estado = 1";
...

            {
                ...
                $metas = $obj_secciones->valor('metas');
                ...
                '
                    ...
                    <div class="grid_4">
                        ...
                        <a href="../admin/recursos/images/ma_800_600_'.$imagen.'" class="gal">

                            <img src="../admin/recursos/images/ma_220_166_'.$imagen.'" alt="'.$metas.'">

                            <!--<img src="../resources/img/ktz-marca-agua-50.png" style="background: none; opacity: 0.5;width: 60px; height: 50px; z-index: 999; margin-left: -220px; margin-top: 60px; position: absolute;" />-->
        ...
        <div class="port">
          ...
          <div class="grid_4">
            ...
            <a href="uploads/galeria/007g.jpg" class="gal">

                <img src="uploads/galeria/007.jpg" alt="">
          ...
          <div class="grid_4">
            ...
            <a href="uploads/galeria/009.jpg" class="gal">
          ...
          <div class="grid_4">
            ...
            <a href="uploads/galeria/007g.jpg" class="gal">
                ...
                <img src="uploads/galeria/010.jpg" alt="">
        ...
        <div class="port">
          ...
          <div class="grid_4">
            ...
            <a href="uploads/galeria/007g.jpg" class="gal"><img src="uploads/galeria/007.jpg" alt=""></a>
