    ...
    <div class="shell">
		...
		<nav id="navigation">
			...
			<ul>
                ...
                <li><a href="conocenos.php" target="_parent" class="active">About Us</a></li>
            ...
            <div class="slider-wrapper theme-default">
                ...
                <ol><div id="slider" class="nivoSlider">
                    ...
                    <?php
                        ...
                        $sql = "select imagen_1_en, imagen_2_en, imagen_3_en, imagen_4_en, imagen_5_en, imagen_6_en, metas_1_en, metas_2_en, metas_3_en, metas_4_en, metas_5_en, metas_6_en from ktz_imagenes_slider where estado = 1 and tipo = 2";
...
<div class="shell">
    ...
    <div class="fil1">
        ...
        <?php
            ...
            $sql = "select contenido_en, imagen from ktz_conocenos where estado = 1";
