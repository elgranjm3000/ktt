...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("div.holder").jPages({
...

            {
                ...
                if(quiere_click == 1)
                    ...
                    location.href="preguntas-frecuentes.php?page="+pages.current;
        ...
        $(".holder a.jp-last").html("&Uacute;ltima &#187;");



        $(".holder a").mouseover(function()
    ...
    function acomoda_lista(ini_page_rec)

    {

        if(ini_page_rec == 1)

            $("#paginator_galeria").attr("start", 1);

        else

            $("#paginator_galeria").attr("start", (ini_page_rec * 10) - 9);
    ...
    <div class="shell">
		...
		<nav id="navigation">
			...
			<ul>
                ...
                <li><a href="preguntas-frecuentes.php?page=1" target="_parent" class="active">FAQ</a></li>
            ...
            <div class="slider-wrapper theme-default">
                ...
                <ol><div id="slider" class="nivoSlider">
                    ...
                    <?php
                        ...
                        $sql = "select imagen_1_en, imagen_2_en, imagen_3_en, imagen_4_en, imagen_5_en, imagen_6_en, metas_1_en, metas_2_en, metas_3_en, metas_4_en, metas_5_en, metas_6_en from ktz_imagenes_slider where estado = 1 and tipo = 5";
...
<div class="shell">
	...
	<section id="contepf">
    	...
    	<div class="titulo"><h1>FAQ</h1></div>
        ...
        <div class="fil1" >
			...
			<ol start="0" id="paginator_galeria">
            	...
            	<li>
                    ...
                    <strong>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</strong>
                ...
                <?php
                    ...
                    $sql = "select pregunta_en, respuesta_en from ktz_preguntas_frecuentes where estado = 1";
...

                    {
                        ...
                        if($obj_secciones->valor('pregunta_en') != "")

                        {

                            echo '<li>';

                                echo '<strong>'.$obj_secciones->valor('pregunta_en').'</strong>';

                                echo '<p>'.$obj_secciones->valor('respuesta_en').'</p>';
        ...
        <div class="fil1">
        	...
        	<!-- Después de 10 registros va la paginación -->
