...
<script type="text/javascript">
    ...
    $(function(){
        ...
        //$('#paginator_galeria').simplePagination();



        $("div.holder").jPages({

            containerID : "paginator_galeria",
        ...
        $(".holder a.jp-first").html("<<");



        $(".holder a.jp-last").html(">>");



        /*$('.paginator_galeria').pagination({
...
<div class="shell">
	...
	<section id="conteproductos">
        ...
        <div class="fil1">
        	...
        	<div class="titulo"><h1>KTZ PRODUCTS - WE ARE MANUFACTURERS</h1></div>
        ...
        <div id="paginator_galeria" class="pagination">
    ...
    <?php
        ...
        $obj_prod = new MantixOaD();



        //$sql = "select ktz_productos.id, ktz_categorias_productos.id as id_cat_prod, ktz_productos.imagen, ktz_productos.estado_nuevo ,ktz_productos.fecha, ktz_categorias_productos.nombre, ktz_categorias_productos.idtipo from ktz_productos, ktz_categorias_productos where ktz_categorias_productos.id = ktz_productos.idcategoria and ktz_productos.estado = 1 order by ktz_productos.fecha desc";

        $sql = "select ktz_productos.id, ktz_categorias_productos.id as id_cat_prod, ktz_productos.imagen, ktz_productos.estado_nuevo ,ktz_productos.fecha, ktz_productos.nombre_eng as nombre from ktz_productos, ktz_categorias_productos where ktz_categorias_productos.id = ktz_productos.idcategoria and ktz_productos.estado = 1 order by ktz_productos.fecha desc";



        $obj_prod->listaSP($sql, "", "");
...

        {
            ...
            $datetime2 = date_create($obj_prod->valor('fecha'));
...

            {
                ...
                $texto_new = '<div class="pdtonew"></div>';
            ...
            if($obj_prod->valor('estado_nuevo')==1)

            {

                $texto_new = '<div class="pdtonew_en"></div>';
            ...
            '
                ...
                <div class="col1" onclick="location.href=\'producto-detalle.php?id_producto='.$obj_prod->valor('id').'&id_cat_prod='.$obj_prod->valor('id_cat_prod').'&idtipo='.$obj_prod->valor('idtipo').'\'" style="cursor: pointer;">
                    ...
                    <div class="itemreg">
                        ...
                        <div class="pdtoimg"><img src="../admin/recursos/images/212_212_'.$obj_prod->valor('imagen').'"></div>



                        <div class="pdtotxt"><h2>'.$obj_prod->valor('nombre').'</h2></div>
                        ...
                        <div class="pdtobtn">
                            ...
                            <a href="#" class="btn"><img src="../resources/img/icono-ktz-shopping.png"> <span>Check Now!</span></a>
    ...
    <div class="fil1">
		...
		<div class="col1">
            ...
            <div class="itemreg">
                ...
                <div class="pdtotxt"><h2>New style of cat scratching tree</h2></div>
                ...
                <div class="pdtobtn">
                	...
                	<a href="#" class="btn"><img src="resources/img/icono-ktz-shopping.png"> <span>Consultar Ahora!</span></a>
	...
	<div class="fil1">
		 ...
		 <!--Después de 5 filas de registros va la paginación... -->
