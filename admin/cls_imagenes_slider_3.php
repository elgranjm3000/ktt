...
class Imagenes_slider_3 extends MantixBase
{
    var $id;
    var $nombre;
    ...
    function __construct()
    {
        ...
        $this->pagina = "imagenes_slider_3.php";
        $this->urlparam = "Imagenes_slider_3";
    ...
    function comprueba_id()
    {
        ...
        $sql = "select id from ktz_imagenes_slider where tipo = 4";
        ...
        {
            $c->ejecutar("insert into ktz_imagenes_slider(imagen_1, tipo ) values ('', 4)");
