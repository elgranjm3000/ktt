...
class Imagenes_slider_1 extends MantixBase
{
    var $id;
    var $nombre;
    ...
    function __construct()
    {
        ...
        $this->pagina = "imagenes_slider_1.php";
        $this->urlparam = "Imagenes_slider_1";
    ...
    function comprueba_id()
    {
        ...
        $sql = "select id from ktz_imagenes_slider where tipo = 2";
        ...
        {
            $c->ejecutar("insert into ktz_imagenes_slider(imagen_1, tipo ) values ('', 2)");
