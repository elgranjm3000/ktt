    ...
    <div class="shell">
		...
		<nav id="navigation">
			...
			<ul>
                ...
                <li><a href="galeria.php" target="_parent" class="active">Galer&iacute;a</a></li>
            ...
            <div class="slider-wrapper theme-default">
                ...
                <ol><div id="slider" class="nivoSlider">
                    ...
                    <?php
                        ...
                        $sql = "select imagen_1, imagen_2, imagen_3, imagen_4, imagen_5, metas_1, metas_2, metas_3, metas_4, metas_5 from ktz_imagenes_slider where estado = 1 and tipo = 4";
...
<div class="shell">
	...
	<section id="contegaleria">
        ...
        <div class="fil1">
            ...
            <div class="titulo"><h1>GALER&Iacute;A</h1></div>
